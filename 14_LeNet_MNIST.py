...
momentum = 0.5
epochs = 15
save_model = '../larger_than_50_MB/save_trained_model/LeNet.pt'
...
'''
step 5: train and validate neural network architecture. Remember, we need to create a folder to store the trained model.
'''
