...
# rf = Roboflow(api_key="H8fBjyMOxQNfr5qbSA4F")
...
class SegformerFinetuner(pl.LightningModule):
    ...
    def __init__(self, id2label, train_dataloader=None, val_dataloader=None, test_dataloader=None, metrics_interval=10):
        ...
        self.train_mean_iou = evaluate_load("mean_iou")
        self.val_mean_iou = evaluate_load("mean_iou")
        self.test_mean_iou = evaluate_load("mean_iou")
...
PATH = '../larger_than_50_MB/team_datasets/image_segmentation/Balloons-1/'

train_dataset = SemanticSegmentationDataset(PATH + 'train/', feature_extractor)
val_dataset = SemanticSegmentationDataset(PATH + 'valid/', feature_extractor)
test_dataset = SemanticSegmentationDataset(PATH + 'test/', feature_extractor)
...
trainer = pl.Trainer(
    ...
    precision=16, 
    log_every_n_steps=2  # Reduce log interval to avoid warning
)
